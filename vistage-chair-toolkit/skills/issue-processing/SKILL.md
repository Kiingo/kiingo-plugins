...
## The Traditional Process (Sound Structure, Mediocre Execution)

**Step 1: Present the Issue** (2-3 min)
**Step 2: Clarify the Issue** (5-10 min)
**Step 3: Identify Root Cause** (5-10 min)
**Step 4: Generate Solutions** (10-15 min)
**Step 5: Commit to Action** (5 min)
...
- The stated issue isn't the real issue (this happens 30-40% of the time)

### The 3-Sentence Frame
...
**What the Chair tells the group:**
"[Name] has an issue. They have 3 minutes. Your job: listen. Not just to what they're saying — listen for what they might NOT be saying. No questions yet."
...
## STEP 2: Clarify the Issue (Enhanced)

### The Failure Modes
- Questions are too shallow ("How many employees do you have?")
- Questions are actually advice in disguise ("Have you considered firing him?")
- Same 2-3 people ask all the questions
- The group accepts the presenter's framing without testing it
- Critical context never surfaces because nobody asks about it
...
**Chair script:**
"For the next 8 minutes, we're in questions-only mode. No advice, no 'have you considered,' no suggestions dressed as questions. Our job is to understand [Name]'s situation so well we could explain it to someone outside this room. If I hear advice, I'm redirecting. This discipline matters."
...
- "If you fix this specific instance, will it come back in 3 months?"
- "What's the pattern underneath this?"

**Layer 4 — Stakes** (forces the presenter to confront what's really at risk):
- "What happens if you do nothing for 90 days?"
- "What's the cost — in dollars, in people, in your own energy — of getting this wrong?"
...
## STEP 3: Identify Root Cause (Enhanced)

### The Failure Modes
- Group jumps to solutions without diagnosing (the most common failure in peer groups)
- Root cause is assumed based on the presenter's frame
- Multiple causes identified but none prioritized
- Systemic issues treated as one-time events

### Root Cause Toolkit — Pick One Per Issue
...
- Why was pipeline thin? → Outbound activity dropped 40%.
- Why? → Sales team was doing implementation work.
- Why? → Lost 2 implementation people and didn't replace them.
- Why? → Hiring process takes 4 months.
